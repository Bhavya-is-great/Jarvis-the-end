...
async function downloadthis() {
    downloadwindow = window.open("/public/commands.txt","_blank");
    await delay(4000);
...
function opentictactoe() {
    tictactoee = window.open('/public/Games/Tic Tac Toe in JavaScript - CodingNepal',"_blank","width=350,height=400");
}
...
function openwordscramble() {
    wordscramblee = window.open('/public/Games/Word Scramble Game',"_blank","width=400,height=400");
}
...
function opennumberguess() {
    numberguess = window.open('/public/Games/Number gusser',"_blank","width=350,height=250");
}
...
function openhangman() {
    hangamngame = window.open('/public/Games/Hangman Game',"_blank","width=800, height=450");
}
...
function opensnakegame() {
    snakegame = window.open('/public/Games/Snake Game in JavaScript',"_blank","width=300,height=350");
}
...
function openrps() {
    rockpaperscissorgame = window.open('/public/Games/Rock Paper Scissors',"_blank","width=450,height=450");
}
...
function openmingamewitht(){
    ...
    mingamewindow1 = window.open("/public/Games/Memory Card Games/Memory Cards Game [Demo 2]", "_blank", "width=400, height=400");
}
...
function openmingamewithoutt(){
    ...
    mingamewindow1 = window.open("/public/Games/Memory Card Games/Memory Cards Game [Demo 1]", "_blank", "width=400, height=400");
}

function typinggame(){
    mingamewindow3 = window.open("/public/Games/Typing Speed Test Game in JavaScript","_blank","width=600 , height=500");
}
